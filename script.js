const translations = {
    tr: {
        ...
        note: "Klayım işlemleri (tokenlerinizin cüzdanlarınızda görünmesi ön satışın tamamlamasının ardından gerçekleşecektir). Süreç, şeffaf ve güvenli bir şekilde yürütülecektir. Daha fazla bilgi için <a href='[iletişim kanalı]' target='_blank'>iletişim kanalımız</a>.",
    ...
    en: {
        ...
        note: "Claim transactions (the appearance of your tokens in your wallets will occur after the completion of the presale) will be conducted transparently and securely. For more details, visit <a href='[communication channel]' target='_blank'>our communication channel</a>.",
    ...
    ar: {
        ...
        note: "عمليات المطالبة (ظهور التوكنات في محافظكم سيتم بعد اكتمال البيع المسبق) ستُجرى بطريقة شفافة وآمنة. لمزيد من التفاصيل، تفضلوا بزيارة <a href='[قناة التواصل]' target='_blank'>قناة التواصل الخاصة بنا</a>.",
    ...
    az: {
        ...
        owned_tokens: "Sizin Tokenlər",
        note: "Klaym əməliyyatları (tokenlərinizin cüzdanlarınızda görünməsi ilkin satışın tamamlanmasından sonra baş verəcək). Proses şəffaf və təhlükəsiz şəkildə həyata keçiriləcək. Ətraflı məlumat üçün <a href='[əlaqə kanalı]' target='_blank'>əlaqə kanalımıza</a> baş çəkin.",
        select_wallet: "Cüzdan Seç",
        metamask: "Metamask",
        wallet_connect_option: "WalletConnect",
        trust_wallet: "Trust Wallet",
    ...
    ru: {
        ...
        note: "Операции по клейму (появление ваших токенов в кошельках произойдет после завершения предпродажи) будут проводиться прозрачно и безопасно. Подробности на <a href='[канал связи]' target='_blank'>нашем канале связи</a>.",
    ...
    zh: {
        ...
        owned_tokens: "拥有的代币",
        note: "领取操作（您的代币将在预售结束后出现在您的钱包中）将以透明和安全的方式进行。详情请访问<a href='[通信渠道]' target='_blank'>我们的通信渠道</a>。",
        select_wallet: "选择钱包",
        metamask: "Metamask",
        wallet_connect_option: "WalletConnect",
        trust_wallet: "Trust Wallet",
    ...
    ur: {
        ...
        note: "دعویٰ کے لین دین (آپ کے ٹوکنز کا آپ کے والیٹس میں ظاہر ہونا پری سیل کے مکمل ہونے کے بعد ہوگا) شفاف اور محفوظ طریقے سے انجام دیا جائے گا۔ مزید تفصیلات کے لیے <a href='[رابطہ چینل]' target='_blank'>ہمارے رابطہ چینل</a> پر جائیں۔",
    ...
    hi: {
        ...
        note: "दावा लेनदेन (आपके टोकन आपके वॉलेट में प्रीसेल पूरा होने के बाद दिखाई देंगे) पारदर्शी और सुरक्षित रूप से आयोजित किए जाएंगे। अधिक जानकारी के लिए <a href='[संचार चैनल]' target='_blank'>हमारे संचार चैनल</a> पर जाएं।",
