...
function translateUI(lang) {
  ...
  document.getElementById("communityTitle").textContent = t.community;
}
...
async function connect(providerType) {
  try {
    if (!window.ethereum) {
...
document.getElementById("trustwalletBtn").addEventListener("click", () => {
  window.open("https://link.trustwallet.com/open_url?coin_id=60&url=https://freedogeai.com", "_blank");
});
